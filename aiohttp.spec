...
Source0  : https://files.pythonhosted.org/packages/68/96/40a765d7d68028c5a6d169b2747ea3f4828ec91a358a63818d468380521c/aiohttp-3.7.3.tar.gz
...
%prep
%setup -q -n aiohttp-3.7.3
cd %{_builddir}/aiohttp-3.7.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605736143
...
cp %{_builddir}/aiohttp-3.7.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/aiohttp/cf3e5d335e7a6b6b41e2da236bd90e5dd8562c87
cp %{_builddir}/aiohttp-3.7.3/vendor/http-parser/LICENSE-MIT %{buildroot}/usr/share/package-licenses/aiohttp/88b9c8fca2f64284b46f0dd05f37329ae8a7a6a8
