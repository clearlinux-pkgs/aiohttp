...
%prep
%setup -q -n aiohttp-3.7.4.post0
cd %{_builddir}/aiohttp-3.7.4.post0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635700961
...
cp %{_builddir}/aiohttp-3.7.4.post0/LICENSE.txt %{buildroot}/usr/share/package-licenses/aiohttp/cf3e5d335e7a6b6b41e2da236bd90e5dd8562c87
cp %{_builddir}/aiohttp-3.7.4.post0/vendor/http-parser/LICENSE-MIT %{buildroot}/usr/share/package-licenses/aiohttp/88b9c8fca2f64284b46f0dd05f37329ae8a7a6a8
